...
import com.example.homeaccommodationtravel.config.AliPayConfig;
import com.example.homeaccommodationtravel.entity.AliPay;
    ...
    public String payNotify(HttpServletRequest request) throws Exception {
        if (request.getParameter("trade_status").equals("TRADE_SUCCESS")) {
            ...
            if (checkSignature) {
                ...
                //根据订单号修改订单状态
                orderMapper.updateStatusByOrderNomber(orderNumber);
            }
        }
        return "success";
    }
